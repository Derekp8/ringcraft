...
try {
  ...
  const report = {
    ...
    note: "Committed screenshot SHA-256 pins and hosted-runner visual reproducibility are separate claims. The extension-only capture explicitly opts out of Strict Manual Mode through the rendered React control; cross-environment layout differences are not silently re-pinned.",
  };
